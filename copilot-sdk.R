...
inputFileName = "App-Output 3_Life_Track_White_Stork_Loburg__Adapt_Time_Lag_for_Regular_Gaps__2022-07-15_09-16-48.rds" #important to set to NULL for movebank-download
